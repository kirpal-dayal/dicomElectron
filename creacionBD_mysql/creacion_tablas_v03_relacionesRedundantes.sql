...
-- Schema fibrosis_v02
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `fibrosis_v02` DEFAULT CHARACTER SET utf8 ;
USE `fibrosis_v02` ;

-- -----------------------------------------------------
-- Table `fibrosis_v02`.`admin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibrosis_v02`.`admin` (
...
-- -----------------------------------------------------
-- Table `fibrosis_v02`.`doctor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibrosis_v02`.`doctor` (
  ...
  CONSTRAINT `fkDoc_id_admin`
    ...
    REFERENCES `fibrosis_v02`.`admin` (`id_admin`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
KEY_BLOCK_SIZE = 1;
...
-- -----------------------------------------------------
-- Table `fibrosis_v02`.`expediente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibrosis_v02`.`expediente` (
  ...
  CONSTRAINT `fkExp_id_doc`
    ...
    REFERENCES `fibrosis_v02`.`doctor` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fibrosis_v02`.`estudio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibrosis_v02`.`estudio` (
  ...
  CONSTRAINT `fkEst_nss_expediente`
    ...
    REFERENCES `fibrosis_v02`.`expediente` (`nss`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fibrosis_v02`.`tomografia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibrosis_v02`.`tomografia` (
  ...
  CONSTRAINT `fkTom_nss_exp`
    FOREIGN KEY (`nss_exp`)
    REFERENCES `fibrosis_v02`.`estudio` (`nss_expediente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fkTom_fecha_estudio`
    FOREIGN KEY (`fecha_estudio`)
    REFERENCES `fibrosis_v02`.`estudio` (`fecha`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fibrosis_v02`.`mascara`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibrosis_v02`.`mascara` (
  `nss_exp` VARCHAR(15) NOT NULL,
  `fecha_estudio` TIMESTAMP NOT NULL,
  `num_tomo` INT NOT NULL,
  ...
  CONSTRAINT `fkMas_nss_exp`
    FOREIGN KEY (`nss_exp`)
    REFERENCES `fibrosis_v02`.`tomografia` (`nss_exp`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fkMas_fecha_estudio`
    FOREIGN KEY (`fecha_estudio`)
    REFERENCES `fibrosis_v02`.`tomografia` (`fecha_estudio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fkMas_num_tomo`
    -- FOREIGN KEY (`num_tomo`)
    -- REFERENCES `fibrosis_v02`.`tomografia` (`num_tomo`)
    FOREIGN KEY (`nss_exp`, `fecha_estudio`, `num_tomo`)
    REFERENCES `fibrosis_v02`.`tomografia` (`nss_exp`, `fecha_estudio`, `num_tomo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fibrosis_v02`.`modifica_doc_estudio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibrosis_v02`.`modifica_doc_estudio` (
