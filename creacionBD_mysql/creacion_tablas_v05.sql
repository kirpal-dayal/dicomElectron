-- Igual a la version 4 pero el campo de imagenes se cambia de BLOB a LONGBLOB
-- Para su ejecucion, puedes copiar y pegar en un archivo sql de workbench el contenido de este
-- archivo o abrir el archivo desde workbench y ejecutarlo 
...
-- Schema fibrosis_v05
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `fibrosis_v05` DEFAULT CHARACTER SET utf8 ;
USE `fibrosis_v05` ;

-- -----------------------------------------------------
-- Table `fibrosis_v05`.`admin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibrosis_v05`.`admin` (
...
-- -----------------------------------------------------
-- Table `fibrosis_v05`.`doctor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibrosis_v05`.`doctor` (
  ...
  CONSTRAINT `fkDoc_id_admin`
    ...
    REFERENCES `fibrosis_v05`.`admin` (`id_admin`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
KEY_BLOCK_SIZE = 1;
...
-- -----------------------------------------------------
-- Table `fibrosis_v05`.`expediente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibrosis_v05`.`expediente` (
  ...
  CONSTRAINT `fkExp_id_doc`
    ...
    REFERENCES `fibrosis_v05`.`doctor` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fibrosis_v05`.`estudio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibrosis_v05`.`estudio` (
  ...
  CONSTRAINT `fkEst_nss_expediente`
    ...
    REFERENCES `fibrosis_v05`.`expediente` (`nss`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fibrosis_v05`.`imagen`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibrosis_v05`.`imagen` (
  ...
  CONSTRAINT `fkTom_nss_exp`
    FOREIGN KEY (`nss_exp`)
    REFERENCES `fibrosis_v05`.`estudio` (`nss_expediente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fkTom_fecha_estudio`
    FOREIGN KEY (`fecha_estudio`)
    REFERENCES `fibrosis_v05`.`estudio` (`fecha`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fibrosis_v05`.`mascara`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibrosis_v05`.`mascara` (
  `nss_exp` VARCHAR(15) NOT NULL,
  `fecha_estudio` TIMESTAMP NOT NULL,
  `num_tomo` INT NOT NULL,
  ...
  CONSTRAINT `fkMas_nss_exp`
    FOREIGN KEY (`nss_exp`)
    REFERENCES `fibrosis_v05`.`imagen` (`nss_exp`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fkMas_fecha_estudio`
    FOREIGN KEY (`fecha_estudio`)
    REFERENCES `fibrosis_v05`.`imagen` (`fecha_estudio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fkMas_num_tomo`
    FOREIGN KEY (`nss_exp`, `fecha_estudio`, `num_tomo`)
    REFERENCES `fibrosis_v05`.`imagen` (`nss_exp`, `fecha_estudio`, `num_tomo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fibrosis_v05`.`modifica_doc_estudio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibrosis_v05`.`modifica_doc_estudio` (
